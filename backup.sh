...
echo "Here we are checking if the directory name
       is provided in the argument or not"
echo " -z will check for the null string 
      and $1 will check if the positional argument
      is passed or not"
if [ -z "$1" ]; then
  
echo "If the name of the folder was not specified 
      in the argument" 
echo "Then the following message will be displayed 
       to the screen"
...
echo " if directory control will enter
